...
/**
 * Touchable Users UploadMedia based on UploadMedia component
 * @param {UploadMediaProps} props
  ...
  return (
    <Wrapper>
      <Section style={styles.section}>
        {!media && (
          <Section.Row>
            <View style={styles.innerUploadMedia}>
...
UploadMedia.navigationOptions = {
  title: TITLE,
}

export default withStyles(getStylesFromProps)(UploadMedia)
